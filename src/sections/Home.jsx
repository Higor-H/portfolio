...
const Home = () => {
    ...
    useEffect(() => {
        var typed = new Typed("#typed_text_home", {
        ...
        <>
            ...
            <section id="home" className={styles.home}>
                <div className={styles.home_conteiner}>
                    ...
                    <p>Estudante de Ciências da Computação na ATITUS (Antiga Imed) e me dedico fortemente na área de tecnologia, tanto em software como em hardware, mesmo focando na área de TI sempre que eu posso eu mesclo conhecimentos de outras áreas em meus projetos, afinal a tecnologia está em tudo.</p>

                    <div className={styles.social_media} >
                        <a href="https://github.com/Higor-H" target="_blank"><i className='bx bxl-github'></i></a>
                        <a href="https://linktr.ee/Higor_Milani" target="_blank"><i className='bx bxs-tree'></i></a>
                        <a href="https://www.instagram.com/higor.milani/" target="_blank"><i className='bx bxl-instagram' ></i></a>
